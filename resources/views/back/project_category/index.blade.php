        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <a href="{{route('back.project_category.update')}}" class="btn btn-sm btn-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning"
                                       href="{{route('back.project_category.update',array('id'=>$dt->id))}}"><i
                                                class="fa fa-pencil"></i> Update</a>
                                </td>
                                <td>
                                    <a onclick="return confirm('Are you sure ?')" class="btn btn-sm btn-danger"
                                       href="{{route('back.project_category.destroy',array('id'=>$dt->id))}}"><i
